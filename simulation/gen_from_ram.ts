    ...
    for (let cnt_x = 0; cnt_x < scr_w; cnt_x++) {
        ...
        for (let vfase = 1; vfase <= 6; vfase++) {
            ...
            switch (vfase) {
                ...
                case 4: {
                    pixel_14m |= 1;
                    cur_state = (pixel_7m & 0x3) == 0 ? VState.RdModes : VState.None;
            ...
            switch (cur_state) {
                ...
                case VState.RdAttrs: {
                    ...
                    if (mode_text) {
                        ...
                        let posy = (cnt_y & 7) ^ 7; // (mode2 >> 2) != 0 ? ((cnt_y & 7)^7) : (((mode2 & 1) << 2) | (((cnt_y >> 1) & 3) ^ 3));
                        ...
                        va = ((mode1 >> 3) << 13) | (posy << 10) | ((mode0 & 0x0f) << 6) | ((mode1 & 7) << 3) | posx;
                    }
